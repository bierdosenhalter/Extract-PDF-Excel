...
class LaneTools {
    ...
    static MyPair<Lane, Lane> getFirstCollidingAndHigher(int oppositeAxis, Block block, Lanes lanes) {
        ...
        if (floorLaneEntry != null) {
            ...
            if (firstColliding != null) {
                ...
                return new MyPair<>(firstColliding.getValue(), higherThanCollidingLane);
            } else {
            ...
            if (higherLaneEntry != null && isKeyLowerOrEqualThanEndOfLane(oppositeAxis, key, higherLaneEntry.getValue())) {
                ...
                return new MyPair<>(higherLaneEntry.getValue(), higherThanHigherLane);
            } else {
    ...
    private static Map.Entry<Double, Lane> getFirstLaneEndAfterKey(int oppositeAxis,
        ...
        // If we have found first lane with end of rect after the pos or No corresponding lane found
        return actualLane;
    }
     ...
     * @return position of rect1 relative to rect2, if they have the same lower position, rect1 is considered at the
     * left of rect2
     */
