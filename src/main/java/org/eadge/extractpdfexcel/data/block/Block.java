 ...
 */
public class Block {
    private final Set<DocumentFont> fonts;
    ...
    public void setPos(int i, double value) {
        bound.setPos(i, value);
    }

    public double getPos(int i) {
        return bound.getPos(i);
    }

    public void setLength(int i, double value) {
        bound.setLength(i, value);
    }

    public double getLength(int i) {
        return bound.getLength(i);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!Objects.equals(formattedText, block.formattedText))
            return false;
        if (!Objects.equals(originalText, block.originalText)) return false;
        if (!Objects.equals(bound, block.bound)) return false;
        if (textOrientation != block.textOrientation) return false;
        if (blockOrientation != block.blockOrientation) return false;
        if (!Objects.equals(fontColors, block.fontColors)) return false;
        if (!Objects.equals(backColors, block.backColors)) return false;
        return Objects.equals(fonts, block.fonts);
