...
public class DefaultBlockMerger extends BlockMerger {
     ...
     */
    private final double threshold_dist_factor;
    /**
     * threshold factor to allow alignment
     */
    private final double threshold_align_factor;
    /**
     * max threshold to allow alignment
     */
    private final double max_align_threshold;
     ...
     * @param outputIsFirstLowerBlock used to store lowerBlock comparison result
    ...
    private static boolean areAlign(int axis,
        ...
        // If two blocks are end aligned or No alignment
        return endDifference >= -threshold / 4 && endDifference < threshold / 2;
    }
