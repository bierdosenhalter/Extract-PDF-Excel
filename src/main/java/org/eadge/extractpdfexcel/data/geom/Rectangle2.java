...
public class Rectangle2 implements Cloneable {
    ...
    /**
     * Set the extrema points of the rectangle
     *
     ...
     * @param vector2 checked rect
     * @return true if the vector is inside along one axis, false otherwise
     */
    ...
    public Vector2 getPoint(int i) {
        return switch (i) {
            case 0 -> new Vector2(getX(), getY());
            case 1 -> new Vector2(getEndPos(X), getY());
            case 2 -> new Vector2(getEndPos(X), getEndPos(Y));
            case 3 -> new Vector2(getX(), getEndPos(Y));
            default -> null;
        };
    }
    ...
    public void movePoint(int point, Vector2 vector2) {
        ...
        switch (point) {
            case 0 -> start.set(vector2);
            case 1 -> {
                start.setY(vector2.getY());
                end.setX(vector2.getX());
            }
            case 2 -> end.set(vector2);
            case 3 -> {
    ...
    public String toString() {
        return "Rect{ coordinates=" + Arrays.toString(coordinates) +
